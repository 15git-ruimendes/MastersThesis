...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_SVM" URI="http://resources/4.0.30/app/PWM_SVM/0" description="Generates 3-phase space vector pulse width modulated &#xA;outputs using CCU8. It supports symmetric &#xA; 7-segment/5-segment SVM algorithm." version="4.0.30" minDaveVersion="4.0.0" instanceLabel="PWM_SVM_0" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="PhaseU_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phuhigh" resourceGroupUri="devicepackage/0/99" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.19"/>
  </hwResources>
  <hwResources name="PhaseV_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phvhigh" resourceGroupUri="devicepackage/0/98" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.20"/>
  </hwResources>
  <hwResources name="PhaseW_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phwhigh" resourceGroupUri="devicepackage/0/96" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <hwResources name="Inverter Enable Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_inverterenable" resourceGroupUri="devicepackage/0/58" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
