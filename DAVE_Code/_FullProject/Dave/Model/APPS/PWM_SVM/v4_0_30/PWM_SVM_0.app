...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_SVM" URI="http://resources/4.0.30/app/PWM_SVM/0" description="Generates 3-phase space vector pulse width modulated &#xA;outputs using CCU8. It supports symmetric &#xA; 7-segment/5-segment SVM algorithm." version="4.0.30" minDaveVersion="4.0.0" instanceLabel="PWM_SVM_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="adc_trigger_global_signal" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_globalsignal_currenttrig" hwSignal="global_signal" hwResource="//@hwResources.3" required="false"/>
  ...
  <virtualSignals name="current_trigger_external_start" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_gp0_unsync_currenttrig" hwSignal="gp0_unsync" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="trigger_trap" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_gp2_unsync_currenttrig" hwSignal="gp2_unsync" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="event_trigger_period/one_match" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_pmus_omds_currenttrig" hwSignal="pmus_omds" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="event_current_trigger_compare_match1_up/down" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_cmds_cmus_cmpch1_currenttrig" hwSignal="cmd1s_cmu1s" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="event_trigger_trap" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_e2as_currenttrig" hwSignal="e2as" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="adc_trigger_ch_status" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_sta_currenttrig" hwSignal="sta" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <virtualSignals name="trigger_slice Status" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_st_currenttrig" hwSignal="st" hwResource="//@hwResources.3" required="false" visible="true"/>
  ...
  <hwResources name="CCU8 ADC trigger Slice" URI="http://resources/4.0.30/app/PWM_SVM/0/hwres_ccu8_config_d" resourceGroupUri="" required="false" mResGrpUri="peripheral/ccu8/*/cc8/*"/>
  ...
  <hwResources name="PhaseW_Low Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/hwres_port_pad_phwlow" resourceGroupUri="port/p/*/pad/*" mResGrpUri="port/p/*/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/Port5/Port5_5.dd#//@provided.31"/>
  </hwResources>
  ...
  <hwResources name="PhaseU_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phuhigh" resourceGroupUri="devicepackage/0/143" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.39"/>
  </hwResources>
  <hwResources name="PhaseV_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phvhigh" resourceGroupUri="devicepackage/0/142" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.38"/>
  </hwResources>
  <hwResources name="PhaseW_High Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_phwhigh" resourceGroupUri="devicepackage/0/141" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <hwResources name="Inverter Enable Pin" URI="http://resources/4.0.30/app/PWM_SVM/0/__pin_hwres_port_pad_inverterenable" resourceGroupUri="devicepackage/0/84" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.30/app/PWM_SVM/0/http://resources/4.0.30/app/PWM_SVM/0/vs_global_ccu8_global/http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_globalsignal_currenttrig" systemDefined="true" sourceSignal="ccu8_global" targetSignal="adc_trigger_global_signal" required="false" targetVirtualSignal="//@virtualSignals.3" proxySrcVirtualSignalUri="http://resources/4.1.14/app/GLOBAL_CCU8/0/vs_global_ccu8_globalsignal" containingProxySignal="true">
    <srcVirtualSignal href="../../GLOBAL_CCU8/v4_1_14/GLOBAL_CCU8_0.app#//@virtualSignals.0"/>
  </connections>
